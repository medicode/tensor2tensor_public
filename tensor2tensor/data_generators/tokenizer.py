...
_WHITESPACE_CHAR_SET = set(
    six.unichr(i) for i in [
        # Unicode Cc, tab, newlines etc.
...
def encode(text):
  ...
  alnum_space_punc = [1 if c in _ALPHANUMERIC_CHAR_SET else 2 if c in _WHITESPACE_CHAR_SET else 0 for c in text]
