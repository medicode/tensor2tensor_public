...
class RevnetTest(tf.test.TestCase):
  ...
  def testH(self):
    rev_block_input = tf.random.uniform([1, 299, 299, 3])
  ...
  def testHStride(self):
    rev_block_input = tf.random.uniform([2, 299, 299, 256])
  ...
  def testInit3D(self):
    images = tf.random.uniform([1, 299, 299, 299, 3])
  ...
  def testUnit1(self):
    x1 = tf.random.uniform([4, 74, 74, 256])
    x2 = tf.random.uniform([4, 74, 74, 256])
  ...
  def testUnit3(self):
    x1 = tf.random.uniform([1, 37, 37, 512])
    x2 = tf.random.uniform([1, 37, 37, 512])
  ...
  def testUnit4(self):
    x1 = tf.random.uniform([1, 19, 19, 1024])
    x2 = tf.random.uniform([1, 19, 19, 1024])
  ...
  def testUnit3D(self):
    x1 = tf.random.uniform([4, 74, 74, 74, 256])
    x2 = tf.random.uniform([4, 74, 74, 74, 256])
  ...
  def testFinalBlock(self):
    x1 = tf.random.uniform([5, 10, 10, 1024])
    x2 = tf.random.uniform([5, 10, 10, 1024])
    logits = revnet.final_block(x1, x2)
    self.assertEqual(logits.shape, [5, 1, 1, 2048])

  def testFinalBlock3D(self):
    x1 = tf.random.uniform([5, 10, 10, 10, 1024])
    x2 = tf.random.uniform([5, 10, 10, 10, 1024])
